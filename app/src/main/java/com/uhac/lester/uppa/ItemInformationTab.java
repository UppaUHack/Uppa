...
public class ItemInformationTab extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_name2.setText(RentMainMenu.selectedName);
        TextView item_price2 = (TextView)findViewById(R.id.item_price2);
        NumberFormat fo = new DecimalFormat("#0.00");
        item_price2.setText("Price: P"+String.valueOf(fo.format(RentMainMenu.selectedPrice)));
        TextView item_location2 = (TextView)findViewById(R.id.item_location2);
        item_location2.setText("Location: "+RentMainMenu.selectedLocation);
        TextView item_desc2 = (TextView)findViewById(R.id.item_desc2);
        item_desc2.setText("Description: "+RentMainMenu.selectedDesc);
